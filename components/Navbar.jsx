...
const NavbarDrawerContents = props => {
  const { open } = props
...
const Navbar = props => {
  ...
  return (
    <div className={clsx('bg-gray-100 dark-mode:bg-gray-900', className)}>
        ...
        >
          ...
          >
            ...
            >
              <button
                className={clsx(
                  'flex flex-row text-gray-900 items-center w-full px-4 py-2 mt-2 text-sm font-semibold text-left bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:focus:bg-gray-600 dark-mode:hover:bg-gray-600 md:w-auto md:inline md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline',
                  { 'bg-gray-200': open }
                )}
                onClick={() => setOpen(!open)}
              >
              ...
              <NavbarDrawerContents open={open} />
            </div>
          </nav>
        </div>
      </div>
